...
class ActorCriticSeperateWeights(ActorCriticBase):
    ...
    def __init__(self, config, vis_obs_space, vec_obs_shape, action_space_shape, recurrence):
        ...
        self.critic_vis_encoder, self.critic_vec_encoder, self.critic_recurrent_layer, self.critic_body = copy.deepcopy(self.actor_vis_encoder), copy.deepcopy(self.actor_vec_encoder), copy.deepcopy(self.actor_recurrent_layer), copy.deepcopy(self.actor_body)
